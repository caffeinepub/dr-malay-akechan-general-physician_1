  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        input: 'var(--input)',
        ring: 'var(--ring)',
        // Blue-Purple-Magenta palette tokens
        cobalt: {
          50:  '#eef2ff',
          100: '#e0e7ff',
          200: '#c7d2fe',
      ...
      boxShadow: {
        'glass': '0 8px 32px rgba(80, 40, 180, 0.12)',
        'glass-lg': '0 16px 48px rgba(80, 40, 180, 0.18)',
      ...
      backgroundImage: {
        ...
        'blue-purple': 'linear-gradient(135deg, #1a1a6e, #4a1a8e)',
        'purple-magenta': 'linear-gradient(135deg, #4a1a8e, #8e1a6e)',
      },
      animation: {
